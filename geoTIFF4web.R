'geoTIFF4web' <- function(source, result, resultpath = 'x:/LCC/GIS/Final/GeoServer/',
                          ...
                          auto = TRUE, rescale = NULL, round = NULL, type = 'FLT4S', overviewResample = 'average',
    ...
    makeNiceTif(r[2], r[3], overwrite = TRUE, type = typeinfo$type, buildOverviews = TRUE,
                overviewResample = overviewResample, vat = vat, stats = TRUE)
